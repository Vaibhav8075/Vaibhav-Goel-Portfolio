    ...
    <section id="profile" className="py-24 border-t border-[#1A1A1A]">
      <div className="flex flex-col md:flex-row gap-12 md:gap-24">
        <div className="w-full md:w-1/3">
          <h2 className="font-mono text-xs tracking-[0.2em] text-[#555555] mb-4">01 // SYSTEM_PROFILE</h2>
          <h3 className="text-3xl font-medium text-[#EAEAEA]">Operational <br/>Parameters</h3>
        </div>
        ...
        <div className="w-full md:w-2/3 flex flex-col gap-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 border-b border-[#1A1A1A] pb-12">
            <div className="flex flex-col gap-2">
              <span className="font-mono text-[10px] tracking-widest text-[#555555]">IDENTIFIER</span>
            ...
            <div className="flex flex-col gap-2">
              <span className="font-mono text-[10px] tracking-widest text-[#555555]">ENVIRONMENT</span>
